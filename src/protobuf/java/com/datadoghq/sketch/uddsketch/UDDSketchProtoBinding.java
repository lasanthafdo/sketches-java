...
public class UDDSketchProtoBinding {
   ...
   */
  public static com.datadoghq.sketch.ddsketch.proto.DDSketch toProto(UDDSketch sketch) {
   ...
   */
  public static UDDSketch fromProto(
